...
export const OBSERVACIONES_SEED = [
  ...
  {id:'o12',grupo:'Otros',txt:'Se han calculado estos honorarios sobre una estimación de PEM según los baremos del COA. Si el **PEM final supera en un 10%** al calculado, se revisarán los honorarios proporcionalmente al incremento/disminución del PEM en un **6,5%**.'},
